...
NOTE: If The input fastq files were split into multiple files, the bismark html report will be generated with the
 alignment report from the first chunk, do not pay attention to this section, it is  not representative of the full
 dataset, use the multiqc report for this.

 The other sections of the report are representative of the full dataset, but the main purpose of this report in our
 pipeline is fore you to look at the nucleotide stats generated by bam2nuc.
