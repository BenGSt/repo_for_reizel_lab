...
NOTE: If The input fastq files were split into multiple files, the bismark html report will be generated with the
      ...
      The other sections of the report are representative of the full dataset, but the main purpose of this report in
      our pipeline is for you to look at the nucleotide stats generated by bam2nuc.
